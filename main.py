...
import utils
from new_york_times_crawler import Crawler
...
if __name__ == '__main__':
    try:
        ...
        nytimes_crawler = Crawler()
        article_infos = nytimes_crawler.run(search_phrase, news_categories, months)
        # article_infos = nytimes_crawler.run("messi", ["Sports","World"], 3)
